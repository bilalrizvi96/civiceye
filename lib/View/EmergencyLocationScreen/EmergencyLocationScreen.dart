...
import 'package:civiceye/View/ReportDoneScreen/ReportDoneScreen.dart';
...
class EmergencyLocationScreen extends StatelessWidget {
  ...
  EmergencyLocationController emergencyLocation = Get.put(EmergencyLocationController());
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    Obx(() => Checkbox(
                        ...
                        onChanged: (value) {
                          ...
                          emergencyLocation.valuesFirst.value = !emergencyLocation.valuesFirst.value;
                ...
                TextFormField(
                  onChanged: (_){
                    emergencyLocation.geoConvert(emergencyLocation.locationController.text);
                    print(emergencyLocation.locationController);
                  },
                  controller: emergencyLocation.locationController,
                  validator: (value){
                    if(value!.isEmpty){
                ...
                Padding(
                  ...
                  child: Text("Critical Emergency Message!",
                    style: TextStyle(
                      fontSize: MediaQuery.of(context).size.width/25,
                      color: Colors.white
                    ),
                  ...
                  children: [
                    ...
                    Obx(() => Checkbox(
                        ...
                        onChanged: (value){
                          ...
                          }if(emergencyLocation.Medical.value == false){
                            emergencyLocation.lost.value = !emergencyLocation.lost.value;
                    ...
                    Obx(() => Checkbox(
                        ...
                        onChanged: (value){
                          if(emergencyLocation.lost.value == true){
                            ...
                            emergencyLocation.Medical.value = !emergencyLocation.Medical.value;
                            print(emergencyLocation.Medical.value);
                          }
                          // setState((){
                          //   this.valuesecond = value!;
                ...
                Row(
                  children: [
                    Obx(() => Checkbox(
                          ...
                          onChanged: (value) {
                            emergencyLocation.other.value = !emergencyLocation.other.value;
                            print(value);
                          }
                      ),
                    ),
                ...
                Row(
                  children: [
                    Obx(() => Checkbox(
                        ...
                        onChanged: (value) {
                          emergencyLocation.termCondition.value = !emergencyLocation.termCondition.value;
                    ...
                    GestureDetector(
                      onTap: (){
                        if(emergencyLocation.termCondition.value==true){
                          emergencyLocation.reportSystem();
                        }else{
                          return Get.snackbar('Warning', 'First accept Term of condition',
                ...
                Text("Out of the country and need Embassy\nassistance?",
