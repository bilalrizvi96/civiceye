                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              // ),
                              child: Center(child: Text("Active Shooter Safety Steps",
                                style: TextStyle(
                          ...
                          Container(
                            ...
                            //   borderRadius: BorderRadius.circular(12)
                            // ),
                            child: Center(child: Text("Take Active Shooter Safety Course",
                              style: TextStyle(
                                  color: Color(0xffFFFFFF),
                                  fontSize: MediaQuery.of(context).size.width/28
                              ),
                          ...
                          Row(
                            children: [
                              Obx(() => Checkbox(
                                ...
                                value: ShooterController.current_shooter_situation.value,
                                onChanged: (value) {
                                  ShooterController.current_shooter_situation.value =! ShooterController.current_shooter_situation.value;
                                  print(ShooterController.current_shooter_situation.value);
                                },
                              ),
                              ),
                              SizedBox(
                              ...
                              Text("Currently In Active Shooter Situation",
                                style: TextStyle(
                            ...
                            children: [
                              ...
                              // ),
                                ...
                                Obx(() => Checkbox(
                                  ...
                                  onChanged: (value) {
                                    if(ShooterController.UserSafe.value == false){
                                      ShooterController.Safe.value = !ShooterController.Safe.value;
                                      print(ShooterController.Safe.value);
                                    }else{
                                      return null;
                                    }
                              ...
                              Obx(() => Checkbox(
                                ...
                                onChanged: (value) {
                                  if(ShooterController.Safe.value == false){
                                    ShooterController.UserSafe.value =! ShooterController.UserSafe.value;
                          ...
                          // ),
                          Text("Define the number of people with you",
                            style: TextStyle(
                                fontSize: MediaQuery.of(context).size.width/30,
                                color: Color(0xffFFFFFF)
                            ),
                            ...
                            children: [
                              Obx(() =>
                                Checkbox(
                                  ...
                                  onChanged: (value) {
                                    ShooterController.acceptterm.value =! ShooterController.acceptterm.value;
                                    // setState(() {
                                    //   this.valuesecond = value!;
                                    // });
                                  },
                              ...
                              GestureDetector(
                                onTap: (){
                                  if(ShooterController.acceptterm.value== true)
                                  {
                                    ShooterController.ActiveshooterInfo();

                                    print('Active Shooter info in true');
                                  } if(ShooterController.acceptterm.value == false){
